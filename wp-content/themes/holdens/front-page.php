...
<section class="services">
    ...
    <div class="container">
        ...
        <div class="allServices">
            <div class="service onScreen">
                <h3><span><?php the_field('service_title_1'); ?></span>
                    <div class="bg"></div>
                </h3>
                <div class="desc">
            ...
            <div class="service onScreen">                
                <h3><span><?php the_field('service_title_2'); ?></span>
                    <div class="bg"></div>
                </h3>
                <div class="desc">
                ...
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/skips.jpg" alt="Everwaste - Collection and Skips Solutions">
            </div>
            <div class="service onScreen">
                    <h3><span><?php the_field('service_title_3'); ?></span>
                    <div class="bg"></div>                    
                </h3>
                <div class="desc">
            ...
            <div class="service onScreen">
                <h3><span><?php the_field('service_title_4'); ?></span>
                <div class="bg"></div>                    
                </h3>
                <div class="desc">
...
<section class="thirds">
    <div class="container">
        <div class="third onScreen">
            <div class="text">
                <?php the_field('way_title'); ?>
                <?php the_field('way_description'); ?>
            </div>
        ...
        <div class="third onScreen">
            <div class="text">
                <?php the_field('smart_title'); ?>
                <?php the_field('smart_description'); ?>
            </div>
            <div class="svgWrapper">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (window.gsap) {
        ...
        const aboutText = document.querySelector('.about .aboutText');
